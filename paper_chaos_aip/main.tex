...
\begin{enumerate}
    ...
    \item \textbf{Outlier Shocks and Regularization:} Trace-based Ridge heuristics must not be paired with quadratic features due to the $\mathcal{O}(M^4)$ over-regularization mechanism (measured log--log slope $3.93$, Ridge-only); hyperparameter selection requires causal temporal validation.
